...
$numberOfTestImagesToGenerate = 0;
$logAfterEveryNumberOfCaptchas = 1000;

$captcha = new SimpleCaptcha();
$captcha->folderTrain = $folder;
//$captcha->folderTest = '/usr/stud/starkf/caffe/examples/captcha/data/test2/';
...
//echo("Deleting old files...\n");
//flush();ob_flush();flush();
//exec("rm -rf " . $captcha->folderTrain);
//exec("mkdir " . $captcha->folderTrain);
//exec("rm -rf " . $captcha->folderTest);
//exec("mkdir " . $captcha->folderTest);
...
flush();ob_flush();flush();
//echo("Create Testing Samples<br />\n");
...
//        'VeraSans' => array('spacing' => -1, 'minSize' => 20, 'maxSize' => 28, 'font' => 'VeraSansBold.ttf'),
	...
	*/
	public function CreateTestImage() {
        ...
        /** Output */
		$this->CreateImage($text);
        $this->WriteImage($this->folderTest . $text);
        $this->Cleanup();
	}
